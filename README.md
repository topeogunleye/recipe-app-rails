...
```sh
  cd my-folder
  git clone git@github.com:topeogunleye/recipe-app-rails.git
```
...
- LinkedIn: [desta-legesse-w-509844213](https://www.linkedin.com/in/desta-legesse-w-509844213/)
...
Feel free to check the [issues page](https://github.com/topeogunleye/recipe-app-rails/issues).
